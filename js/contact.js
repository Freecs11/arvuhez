...
! function(n, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : n.anime = e() }(this, function() {
    ...
    function s(n, e) {
        ...
        function g(n) { var t = e ? e * n / 1e3 : n; return t = d < 1 ? Math.exp(-t * d * l) * (v * Math.cos(p * t) + h * Math.sin(p * t)) : (v + h * t) * Math.exp(-t * l), 0 === n || 1 === n ? n : 1 - t }
        return e ? g : function() {
            var e = r.springs[n];
            if (e) return e;
            for (var t = 0, a = 0;;)
    ...
    function f(n) {
        return void 0 === n && (n = 10),
            function(e) { return Math.ceil(a(e, 1e-6, 1) * n) * (1 / n) }
    }
    var l, d, p = function() {
            var n = 11,
                e = 1 / (n - 1);
            ...
            return function(t, r, a, i) {
                if (0 <= t && t <= 1 && 0 <= a && a <= 1) {
                    ...
                    return function(n) { return t === r && a === i ? n : 0 === n || 1 === n ? n : o(f(n), r, i) }
                }
        ...
        v = (l = { linear: function() { return function(n) { return n } } }, d = {
            ...
            Bounce: function() { return function(n) { for (var e, t = 4; n < ((e = Math.pow(2, --t)) - 1) / 11;); return 1 / Math.pow(4, 3 - t) - 7.5625 * Math.pow((3 * e - 2) / 22 - n, 2) } },
            Elastic: function(n, e) {
                void 0 === n && (n = 1), void 0 === e && (e = .5);
                var t = a(n, 1, 10),
                    r = a(e, .1, 2);
                return function(n) { return 0 === n || 1 === n ? n : -t * Math.pow(2, 10 * (n - 1)) * Math.sin((n - 1 - r / (2 * Math.PI) * Math.asin(1 / t)) * (2 * Math.PI) / r) }
            }
            ...
            var e = d[n];
            l["easeIn" + n] = e, l["easeOut" + n] = function(n, t) { return function(r) { return 1 - e(n, t)(1 - r) } }, l["easeInOut" + n] = function(n, t) { return function(r) { return r < .5 ? e(n, t)(2 * r) / 2 : 1 - e(n, t)(-2 * r + 2) / 2 } }, l["easeOutIn" + n] = function(n, t) { return function(r) { return r < .5 ? (1 - e(n, t)(1 - 2 * r)) / 2 : (e(n, t)(2 * r - 1) + 1) / 2 } }
        }), l);
    ...
    function O(n) {
        return i.rgb(n) ? (t = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(e = n)) ? "rgba(" + t[1] + ",1)" : e : i.hex(n) ? (r = n.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(n, e, t, r) { return e + e + t + t + r + r }), a = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r), "rgba(" + parseInt(a[1], 16) + "," + parseInt(a[2], 16) + "," + parseInt(a[3], 16) + ",1)") : i.hsl(n) ? function(n) {
            ...
            function s(n, e, t) { return t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? n + 6 * (e - n) * t : t < .5 ? e : t < 2 / 3 ? n + (e - n) * (2 / 3 - t) * 6 : n }
            if (0 == u) e = t = r = i;
            else {
    ...
    function V(n, e, t) {
        function r(t) { void 0 === t && (t = 0); var r = e + t >= 1 ? e + t : 0; return n.el.getPointAtLength(r) }
        var a = H(n.el, n.svg),
            o = r(),
            u = r(-1),
            i = r(1),
    ...
    function Y(n, e) {
        ...
        var a = i.arr(n) ? n : [n];
        return a.map(function(n, t) { var r = i.obj(n) && !i.pth(n) ? n : { value: n }; return i.und(r.delay) && (r.delay = t ? 0 : e.delay), i.und(r.endDelay) && (r.endDelay = t === a.length - 1 ? e.endDelay : 0), r }).map(function(n) { return k(n, t) })
    }
    ...
    function Z(n, e) {
        ...
        for (var a in r && (e = k(function(n) {
                for (var e = m(y(n.map(function(n) { return Object.keys(n) })), function(n) { return i.key(n) }).reduce(function(n, e) { return n.indexOf(e) < 0 && n.push(e), n }, []), t = {}, r = function(r) {
                        var a = e[r];
                        t[a] = n.map(function(n) { var e = {}; for (var t in n) i.key(t) ? t == a && (e.value = n[t]) : e[t] = n[t]; return e })
    ...
    function G(n, e) {
        ...
        return n.tweens.map(function(r) {
            var a = function(n, e) {
                    ...
                    for (var r in n) {
                        var a = P(n[r], e);
                        i.arr(a) && 1 === (a = a.map(function(n) { return P(n, e) })).length && (a = a[0]), t[r] = a
                    }
    ...
    var Q = {
        css: function(n, e, t) { return n.style[e] = t },
        attribute: function(n, e, t) { return n.setAttribute(e, t) },
        object: function(n, e, t) { return n[e] = t },
    ...
    function R(n, e) {
        var t = n.length,
            ...
            a = {};
        return a.duration = t ? Math.max.apply(Math, n.map(function(n) { return r(n) + n.duration })) : e.duration, a.delay = t ? Math.min.apply(Math, n.map(function(n) { return r(n) + n.delay })) : e.delay, a.endDelay = t ? a.duration - Math.max.apply(Math, n.map(function(n) { return r(n) + n.duration - n.endDelay })) : e.endDelay, a
    }
    var J = 0;
    var K = [],
        U = function() {
            ...
            return "undefined" != typeof document && document.addEventListener("visibilitychange", function() { en.suspendWhenDocumentHidden && (nn() ? n = cancelAnimationFrame(n) : (K.forEach(function(n) { return n._onDocumentVisibility() }), U())) }),
    ...
    function en(t) {
        ...
        var l, d, p, v, h, g, y, b, M = (d = w(n, l = t), p = w(e, l), v = Z(p, l), h = X(l.targets), g = _(h, v), y = R(g, p), b = J, J++, k(d, { id: b, children: [], animatables: h, animations: g, duration: y.duration, delay: y.delay, endDelay: y.endDelay }));
        f(M);
    ...
    return en.version = "3.2.1", en.speed = 1, en.suspendWhenDocumentHidden = !0, en.running = K, en.remove = function(n) { for (var e = W(n), t = K.length; t--;) rn(e, K[t]) }, en.get = A, en.set = z, en.convertPx = D, en.path = function(n, e) {
        var t = i.str(n) ? g(n)[0] : n,
            r = e || 100;
        return function(n) { return { property: n, el: t, svg: H(t), totalLength: q(t) * (r / 100) } }
    }, en.setDashoffset = function(n) { var e = q(n); return n.setAttribute("stroke-dasharray", e), e }, en.stagger = function(n, e) {
        void 0 === e && (e = {});
    ...
    }, en.easing = h, en.penner = v, en.random = function(n, e) { return Math.floor(Math.random() * (e - n + 1)) + n }, en
});
...
function quest_129842_features() {
    let actionAnims = {};
    ...
    let anim_129842_1_in_129842_3 = actionAnims["anim_129842_1_in_129842_3"];

    if (anim_129842_1_in_129842_3) {
        anim_129842_1_in_129842_3.restart();
    } else {

        let anim_129842_1_in_129842_3 = anime({
            targets: "#Contact-us-1",
        ...
        actionAnims["anim_129842_1_in_129842_3"] = anim_129842_1_in_129842_3;

    }


    let anim_129842_5_in_129842_4 = anime({
        targets: "#Mail---arvuhez-gmail-1",
    ...
    anim_129842_5_in_129842_4.pause();
    anim_129842_5_in_129842_4.reverse();
    anim_129842_5_in_129842_4.seek(0);

    actionAnims["anim_129842_5_in_129842_4"] = anim_129842_5_in_129842_4;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("Mail---arvuhez-gmail-1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:50");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129842:2:50");


            let anim_129842_5_in_129842_4 = actionAnims["anim_129842_5_in_129842_4"];

            if (anim_129842_5_in_129842_4) {
                anim_129842_5_in_129842_4.pause();
                anim_129842_5_in_129842_4.reverse();
                anim_129842_5_in_129842_4.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:50"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:50");
    ...
    let anim_129842_6_in_129842_5 = anime({
        targets: "#Where-to-find-us---1",
    ...
    anim_129842_6_in_129842_5.pause();
    anim_129842_6_in_129842_5.reverse();
    anim_129842_6_in_129842_5.seek(0);

    actionAnims["anim_129842_6_in_129842_5"] = anim_129842_6_in_129842_5;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("Where-to-find-us---1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:49");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129842:2:49");


            let anim_129842_6_in_129842_5 = actionAnims["anim_129842_6_in_129842_5"];

            if (anim_129842_6_in_129842_5) {
                anim_129842_6_in_129842_5.pause();
                anim_129842_6_in_129842_5.reverse();
                anim_129842_6_in_129842_5.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:49"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:49");
    ...
    let anim_129842_7_in_129842_6 = anime({
        targets: "#IMAGE-9",
        translateX: { value: [-100, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_7_in_129842_6.pause();
    anim_129842_7_in_129842_6.reverse();
    anim_129842_7_in_129842_6.seek(0);

    actionAnims["anim_129842_7_in_129842_6"] = anim_129842_7_in_129842_6;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("IMAGE-9").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:216");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129842:2:216",
                featureId: "129842:7",
            });

            fireScrollOffTriggers.push("129842:2:216");


            let anim_129842_7_in_129842_6 = actionAnims["anim_129842_7_in_129842_6"];

            if (anim_129842_7_in_129842_6) {
                anim_129842_7_in_129842_6.pause();
                anim_129842_7_in_129842_6.reverse();
                anim_129842_7_in_129842_6.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:216"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:216");
    ...
    let anim_129842_8_in_129842_7 = anime({
        targets: "#On-Campus-1",
        translateX: { value: [100, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_8_in_129842_7.pause();
    anim_129842_8_in_129842_7.reverse();
    anim_129842_8_in_129842_7.seek(0);

    actionAnims["anim_129842_8_in_129842_7"] = anim_129842_8_in_129842_7;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("On-Campus-1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:51");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129842:2:51");


            let anim_129842_8_in_129842_7 = actionAnims["anim_129842_8_in_129842_7"];

            if (anim_129842_8_in_129842_7) {
                anim_129842_8_in_129842_7.pause();
                anim_129842_8_in_129842_7.reverse();
                anim_129842_8_in_129842_7.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:51"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:51");
    ...
    let anim_129842_9_in_129842_8 = anime({
        targets: "#Beaulieu--b-timent-2-1",
        translateY: { value: [-50, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_9_in_129842_8.pause();
    anim_129842_9_in_129842_8.reverse();
    anim_129842_9_in_129842_8.seek(0);

    actionAnims["anim_129842_9_in_129842_8"] = anim_129842_9_in_129842_8;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("Beaulieu--b-timent-2-1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:218");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129842:2:218",
                featureId: "129842:9",
            });

            fireScrollOffTriggers.push("129842:2:218");


            let anim_129842_9_in_129842_8 = actionAnims["anim_129842_9_in_129842_8"];

            if (anim_129842_9_in_129842_8) {
                anim_129842_9_in_129842_8.pause();
                anim_129842_9_in_129842_8.reverse();
                anim_129842_9_in_129842_8.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:218"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:218");
    ...
    let anim_129842_10_in_129842_9 = anime({
        targets: "#IMAGE-8",
        scale: { value: [1.5, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        translateY: { value: [-100, 0], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_10_in_129842_9.pause();
    anim_129842_10_in_129842_9.reverse();
    anim_129842_10_in_129842_9.seek(0);

    actionAnims["anim_129842_10_in_129842_9"] = anim_129842_10_in_129842_9;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("IMAGE-8").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:217");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129842:2:217",
                featureId: "129842:10",
            });

            fireScrollOffTriggers.push("129842:2:217");


            let anim_129842_10_in_129842_9 = actionAnims["anim_129842_10_in_129842_9"];

            if (anim_129842_10_in_129842_9) {
                anim_129842_10_in_129842_9.pause();
                anim_129842_10_in_129842_9.reverse();
                anim_129842_10_in_129842_9.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:217"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:217");
    ...
    let anim_129842_16_in_129842_10 = actionAnims["anim_129842_16_in_129842_10"];

    if (anim_129842_16_in_129842_10) {
        anim_129842_16_in_129842_10.restart();
    } else {

        let anim_129842_16_in_129842_10 = anime({
            targets: "#Contact-us",
            scale: { value: [1.5, 1], duration: 1000, delay: 500, easing: "easeInOutExpo" },
            translateX: { value: [150, 0], duration: 1000, delay: 500, easing: "easeInOutExpo" },
            opacity: { value: [0, 1], duration: 1000, delay: 500, easing: "easeInOutExpo" },
        ...
        actionAnims["anim_129842_16_in_129842_10"] = anim_129842_16_in_129842_10;

    }


    let anim_129842_17_in_129842_11 = anime({
        targets: "#IMAGE-3",
        translateY: { value: [50, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_17_in_129842_11.pause();
    anim_129842_17_in_129842_11.reverse();
    anim_129842_17_in_129842_11.seek(0);

    actionAnims["anim_129842_17_in_129842_11"] = anim_129842_17_in_129842_11;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("IMAGE-3").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:245");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129842:2:245",
                featureId: "129842:17",
            });

            fireScrollOffTriggers.push("129842:2:245");


            let anim_129842_17_in_129842_11 = actionAnims["anim_129842_17_in_129842_11"];

            if (anim_129842_17_in_129842_11) {
                anim_129842_17_in_129842_11.pause();
                anim_129842_17_in_129842_11.reverse();
                anim_129842_17_in_129842_11.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:245"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:245");
    ...
    let anim_129842_18_in_129842_12 = anime({
        targets: "#Where-to-find-us--",
        scale: { value: [1.5, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        translateY: { value: [100, 0], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_18_in_129842_12.pause();
    anim_129842_18_in_129842_12.reverse();
    anim_129842_18_in_129842_12.seek(0);

    actionAnims["anim_129842_18_in_129842_12"] = anim_129842_18_in_129842_12;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("Where-to-find-us--").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:246");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129842:2:246",
                featureId: "129842:18",
            });

            fireScrollOffTriggers.push("129842:2:246");


            let anim_129842_18_in_129842_12 = actionAnims["anim_129842_18_in_129842_12"];

            if (anim_129842_18_in_129842_12) {
                anim_129842_18_in_129842_12.pause();
                anim_129842_18_in_129842_12.reverse();
                anim_129842_18_in_129842_12.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:246"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:246");
    ...
    let anim_129842_19_in_129842_13 = anime({
        targets: "#Mail---arvuhez-gmail",
        translateX: { value: [-100, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_19_in_129842_13.pause();
    anim_129842_19_in_129842_13.reverse();
    anim_129842_19_in_129842_13.seek(0);

    actionAnims["anim_129842_19_in_129842_13"] = anim_129842_19_in_129842_13;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("Mail---arvuhez-gmail").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:247");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129842:2:247",
                featureId: "129842:19",
            });

            fireScrollOffTriggers.push("129842:2:247");


            let anim_129842_19_in_129842_13 = actionAnims["anim_129842_19_in_129842_13"];

            if (anim_129842_19_in_129842_13) {
                anim_129842_19_in_129842_13.pause();
                anim_129842_19_in_129842_13.reverse();
                anim_129842_19_in_129842_13.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:247"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:247");
    ...
    let anim_129842_20_in_129842_14 = anime({
        targets: "#On-Campus",
        scale: { value: [1.5, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        translateY: { value: [-100, 0], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
    ...
    anim_129842_20_in_129842_14.pause();
    anim_129842_20_in_129842_14.reverse();
    anim_129842_20_in_129842_14.seek(0);

    actionAnims["anim_129842_20_in_129842_14"] = anim_129842_20_in_129842_14;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("On-Campus").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:248");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129842:2:248",
                featureId: "129842:20",
            });

            fireScrollOffTriggers.push("129842:2:248");


            let anim_129842_20_in_129842_14 = actionAnims["anim_129842_20_in_129842_14"];

            if (anim_129842_20_in_129842_14) {
                anim_129842_20_in_129842_14.pause();
                anim_129842_20_in_129842_14.reverse();
                anim_129842_20_in_129842_14.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:248"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:248");
    ...
    let anim_129842_21_in_129842_15 = anime({
        targets: "#IMAGE-10",
        translateY: { value: [50, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129842_21_in_129842_15.pause();
    anim_129842_21_in_129842_15.reverse();
    anim_129842_21_in_129842_15.seek(0);

    actionAnims["anim_129842_21_in_129842_15"] = anim_129842_21_in_129842_15;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("IMAGE-10").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129842:2:8");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129842:2:8");


            let anim_129842_21_in_129842_15 = actionAnims["anim_129842_21_in_129842_15"];

            if (anim_129842_21_in_129842_15) {
                anim_129842_21_in_129842_15.pause();
                anim_129842_21_in_129842_15.reverse();
                anim_129842_21_in_129842_15.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129842:2:8"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129842:2:8");
...
document.addEventListener("DOMContentLoaded", quest_129842_features);
0
0