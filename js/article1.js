...
function quest_129853_features() {
    let actionAnims = {};
    ...
    let anim_129853_5_in_129853_5 = actionAnims["anim_129853_5_in_129853_5"];

    if (anim_129853_5_in_129853_5) {
        anim_129853_5_in_129853_5.restart();
    } else {

        let anim_129853_5_in_129853_5 = anime({
            targets: "#Positive-thinking-br",
        ...
        actionAnims["anim_129853_5_in_129853_5"] = anim_129853_5_in_129853_5;

    }


    let anim_129853_6_in_129853_6 = anime({
        targets: "#These-athletes-are-p-1",
    ...
    anim_129853_6_in_129853_6.pause();
    anim_129853_6_in_129853_6.reverse();
    anim_129853_6_in_129853_6.seek(0);

    actionAnims["anim_129853_6_in_129853_6"] = anim_129853_6_in_129853_6;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("These-athletes-are-p-1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:289");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129853:2:289",
                featureId: "129853:6",
            });

            fireScrollOffTriggers.push("129853:2:289");


            let anim_129853_6_in_129853_6 = actionAnims["anim_129853_6_in_129853_6"];

            if (anim_129853_6_in_129853_6) {
                anim_129853_6_in_129853_6.pause();
                anim_129853_6_in_129853_6.reverse();
                anim_129853_6_in_129853_6.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:289"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:289");
    ...
    let anim_129853_11_in_129853_7 = actionAnims["anim_129853_11_in_129853_7"];

    if (anim_129853_11_in_129853_7) {
        anim_129853_11_in_129853_7.restart();
    } else {

        let anim_129853_11_in_129853_7 = anime({
            targets: "#Positive-thinking-br-1",
        ...
        actionAnims["anim_129853_11_in_129853_7"] = anim_129853_11_in_129853_7;

    }


    let anim_129853_12_in_129853_8 = anime({
        targets: "#These-athletes-are-p-3",
        translateY: { value: [50, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129853_12_in_129853_8.pause();
    anim_129853_12_in_129853_8.reverse();
    anim_129853_12_in_129853_8.seek(0);

    actionAnims["anim_129853_12_in_129853_8"] = anim_129853_12_in_129853_8;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("These-athletes-are-p-3").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:94");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129853:2:94");


            let anim_129853_12_in_129853_8 = actionAnims["anim_129853_12_in_129853_8"];

            if (anim_129853_12_in_129853_8) {
                anim_129853_12_in_129853_8.pause();
                anim_129853_12_in_129853_8.reverse();
                anim_129853_12_in_129853_8.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:94"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:94");
    ...
    let anim_129853_13_in_129853_9 = anime({
        targets: "#IMAGE-5",
    ...
    anim_129853_13_in_129853_9.pause();
    anim_129853_13_in_129853_9.reverse();
    anim_129853_13_in_129853_9.seek(0);

    actionAnims["anim_129853_13_in_129853_9"] = anim_129853_13_in_129853_9;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("IMAGE-5").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:7");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129853:2:7");


            let anim_129853_13_in_129853_9 = actionAnims["anim_129853_13_in_129853_9"];

            if (anim_129853_13_in_129853_9) {
                anim_129853_13_in_129853_9.pause();
                anim_129853_13_in_129853_9.reverse();
                anim_129853_13_in_129853_9.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:7"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:7");
    ...
    let anim_129853_14_in_129853_10 = anime({
        targets: "#These-athletes-are-p-2",
        scale: { value: [1.5, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        translateX: { value: [-150, 0], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129853_14_in_129853_10.pause();
    anim_129853_14_in_129853_10.reverse();
    anim_129853_14_in_129853_10.seek(0);

    actionAnims["anim_129853_14_in_129853_10"] = anim_129853_14_in_129853_10;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("These-athletes-are-p-2").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:97");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129853:2:97");


            let anim_129853_14_in_129853_10 = actionAnims["anim_129853_14_in_129853_10"];

            if (anim_129853_14_in_129853_10) {
                anim_129853_14_in_129853_10.pause();
                anim_129853_14_in_129853_10.reverse();
                anim_129853_14_in_129853_10.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:97"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:97");
    ...
    let anim_129853_15_in_129853_11 = anime({
        targets: "#Athletes-Unlimited-l-1",
        translateX: { value: [-100, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129853_15_in_129853_11.pause();
    anim_129853_15_in_129853_11.reverse();
    anim_129853_15_in_129853_11.seek(0);

    actionAnims["anim_129853_15_in_129853_11"] = anim_129853_15_in_129853_11;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("Athletes-Unlimited-l-1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:98");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129853:2:98");


            let anim_129853_15_in_129853_11 = actionAnims["anim_129853_15_in_129853_11"];

            if (anim_129853_15_in_129853_11) {
                anim_129853_15_in_129853_11.pause();
                anim_129853_15_in_129853_11.reverse();
                anim_129853_15_in_129853_11.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:98"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:98");
    ...
    let anim_129853_16_in_129853_12 = anime({
        targets: "#This-initiative-allo-1",
        translateX: { value: [-100, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129853_16_in_129853_12.pause();
    anim_129853_16_in_129853_12.reverse();
    anim_129853_16_in_129853_12.seek(0);

    actionAnims["anim_129853_16_in_129853_12"] = anim_129853_16_in_129853_12;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("This-initiative-allo-1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:99");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            fireScrollOffTriggers.push("129853:2:99");


            let anim_129853_16_in_129853_12 = actionAnims["anim_129853_16_in_129853_12"];

            if (anim_129853_16_in_129853_12) {
                anim_129853_16_in_129853_12.pause();
                anim_129853_16_in_129853_12.reverse();
                anim_129853_16_in_129853_12.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:99"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:99");
    ...
    let anim_129853_17_in_129853_13 = anime({
        targets: "#Lorem-ipsum-dolor-si",
        translateX: { value: [-100, 0], duration: 750, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 750, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129853_17_in_129853_13.pause();
    anim_129853_17_in_129853_13.reverse();
    anim_129853_17_in_129853_13.seek(0);

    actionAnims["anim_129853_17_in_129853_13"] = anim_129853_17_in_129853_13;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("Lorem-ipsum-dolor-si").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:384");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129853:2:384",
                featureId: "129853:17",
            });

            fireScrollOffTriggers.push("129853:2:384");


            let anim_129853_17_in_129853_13 = actionAnims["anim_129853_17_in_129853_13"];

            if (anim_129853_17_in_129853_13) {
                anim_129853_17_in_129853_13.pause();
                anim_129853_17_in_129853_13.reverse();
                anim_129853_17_in_129853_13.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:384"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:384");
    ...
    let anim_129853_18_in_129853_14 = anime({
        targets: "#as-they-play-for-the-1",
        scale: { value: [1.5, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        translateY: { value: [100, 0], duration: 1000, delay: 0, easing: "easeInOutExpo" },
        opacity: { value: [0, 1], duration: 1000, delay: 0, easing: "easeInOutExpo" },
    });

    anim_129853_18_in_129853_14.pause();
    anim_129853_18_in_129853_14.reverse();
    anim_129853_18_in_129853_14.seek(0);

    actionAnims["anim_129853_18_in_129853_14"] = anim_129853_18_in_129853_14;

    document.addEventListener("scroll", function(e) {

        let divRect = document.getElementById("as-they-play-for-the-1").getBoundingClientRect();

        let hasFired = scrollTriggersFired.filter((t) => t.element === "129853:2:103");
        ...
        if (window.quest_page_mode !== "edit" &&
            ...
            scrollTriggersFired.push({
                element: "129853:2:103",
                featureId: "129853:18",
            });

            fireScrollOffTriggers.push("129853:2:103");


            let anim_129853_18_in_129853_14 = actionAnims["anim_129853_18_in_129853_14"];

            if (anim_129853_18_in_129853_14) {
                anim_129853_18_in_129853_14.pause();
                anim_129853_18_in_129853_14.reverse();
                anim_129853_18_in_129853_14.play();
            } else {
        ...
        if (
            ...
            if (!true) {
                scrollTriggersFired = scrollTriggersFired.filter(
                    (t) => t.element !== "129853:2:103"
                );
            }
        }

        let shouldScrollOffFire = !true && fireScrollOffTriggers.includes("129853:2:103");
...
document.addEventListener("DOMContentLoaded", quest_129853_features);
0
0